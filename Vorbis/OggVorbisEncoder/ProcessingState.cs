...
public class ProcessingState
{
        ...
        float[][] gmdct)
    {
        ...
        {
            var submap = mapping.ChannelMuxList[i % mapping.ChannelMuxList.Length];
        ...
        for (var i = 0; i < mapping.SubMaps; i++)
        {
            ...
            for (var j = 0; j < channels; j++)
                if (mapping.ChannelMuxList[j % mapping.ChannelMuxList.Length] == i)
                {
        ...
        float[] localAmpMax)
    {
        ...
        for (var channel = 0; channel < inputPcm.Length; channel++)
        {
            ...
            var submap = mapping.ChannelMuxList[channel % mapping.ChannelMuxList.Length];
