...
namespace NVorbis
{
    ...
    /// </summary>
    public sealed class NVorbisReader : IVorbisReader
    {
        internal static Func<Stream, bool, Contracts.IContainerReader> CreateContainerReader { get; set; } = (s, cod) => new Ogg.VorbisContainerReader(s, cod);
        ...
        /// </summary>
        public event EventHandler<VorbisNewStreamEventArgs> NewStream;

        /// <summary>
        /// Creates a new instance of <see cref="NVorbisReader"/> reading from the specified file.
        /// </summary>
        /// <param name="fileName">The file to read from.</param>
        public NVorbisReader(string fileName)
            : this(File.OpenRead(fileName), true)
        {
        }

        /// <summary>
        /// Creates a new instance of <see cref="NVorbisReader"/> reading from the specified stream, optionally taking ownership of it.
        /// </summary>
        ...
        public NVorbisReader(Stream stream, bool closeOnDispose = true)
        {
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        ...
        public NVorbisReader(Contracts.IContainerReader containerReader) => throw new NotSupportedException();

        [Obsolete("Use \"new StreamDecoder(Contracts.IPacketProvider)\" instead.", true)]
        public NVorbisReader(Contracts.IPacketProvider packetProvider) => throw new NotSupportedException();
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        private bool ProcessNewStream(Contracts.IPacketProvider packetProvider)
        {
            ...
            var ea = new VorbisNewStreamEventArgs(decoder);
        ...
        public INVorbisStreamStatus[] Stats => throw new NotSupportedException();
